...
export const PRODUCTS: Product[] = [
  // --- RELOJES (Cargados desde Tabla - Precios Redondeados) ---
  {
    id: 'w-poedagar-613-dorado',
    name: 'POEDAGAR MAGNATE SQUARE',
    brand: 'Poedagar',
    price: 290000,
    offerPrice: 260000,
    category: ProductCategory.WATCH,
    description: 'El Poedagar Magnate Square redefine la elegancia contemporánea con su distintiva caja cuadrada y un acabado dorado integral que proyecta autoridad. — CARACTERÍSTICAS: Agujas luminiscentes, fechador automático, resistencia al agua 3ATM — MATERIAL DE LA CAJA: Aleación de alta resistencia — MATERIAL DE LA CORREA: Acero inoxidable dorado — CRISTAL: Mineral reforzado anti‑rayaduras — MOVIMIENTO: Cuarzo de precisión — DIÁMETRO DE LA CAJA: 40mm.',
    image: 'https://placehold.co/600x600/FFFFFF/000000?text=Magnate+Square',
    isStock: true,
    isBestSeller: true
  },
  {
    id: 'w-poedagar-613-acero',
    name: 'POEDAGAR IMPERIAL STEEL',
    brand: 'Poedagar',
    price: 290000,
    offerPrice: 260000,
    category: ProductCategory.WATCH,
    description: 'Este modelo destaca por su construcción robusta en acero pulido y un diseño cuadrado que rompe con lo convencional, proporcionando un aire de modernidad y pulcritud. — CARACTERÍSTICAS: Visualización de fecha, manecillas con brillo nocturno, sellado hermético — MATERIAL DE LA CAJA: Aleación de zinc — MATERIAL DE LA CORREA: Acero inoxidable plateado — CRISTAL: Mineral de alta dureza — MOVIMIENTO: Cuarzo — DIÁMETRO DE LA CAJA: 40mm.',
    image: 'https://placehold.co/600x600/FFFFFF/000000?text=Imperial+Steel',
    isStock: true
  },
  {
    id: 'w-poedagar-613-cuero',
    name: 'POEDAGAR LEGACY LEATHER',
    brand: 'Poedagar',
    price: 270000,
    offerPrice: 240000,
    category: ProductCategory.WATCH,
    description: 'El Poedagar Legacy Leather equilibra la audacia de su caja geométrica con la calidez clásica de una correa de cuero seleccionada, consolidándose como un estándar de buen gusto. — CARACTERÍSTICAS: Calendario funcional, punteros luminosos, diseño ergonómico — MATERIAL DE LA CAJA: Aleación metálica — MATERIAL DE LA CORREA: Cuero legítimo — CRISTAL: Mineral resistente a impactos — MOVIMIENTO: Cuarzo analógico — DIÁMETRO DE LA CAJA: 40mm.',
  ...
  },
  {
    ...
    offerPrice: 270000,
    category: ProductCategory.WATCH,
    description: 'Una obra maestra de la ingeniería visual que presenta una esfera compleja con sub-diales funcionales inspirados en la alta competición, ofreciendo un diseño deportivo refinado. — CARACTERÍSTICAS: Cronógrafo funcional, fechador, resistencia al agua, alta luminosidad — MATERIAL DE LA CAJA: Acero inoxidable — MATERIAL DE LA CORREA: Acero inoxidable — CRISTAL: Mineral anti‑reflectante — MOVIMIENTO: Cuarzo multifunción — DIÁMETRO DE LA CAJA: 42mm.',
  ...
  },
  {
    ...
    offerPrice: 260000,
    category: ProductCategory.WATCH,
    description: 'Diseñado para la exploración urbana, el Navigator Pro combina una legibilidad excepcional con un diseño técnico avanzado y un bisel detallado. — ATRIBUTOS TÉCNICOS: Características: Bisel decorativo, manecillas de alta luminiscencia, calendario — MATERIAL DE LA CAJA: Aleación de alta densidad — MATERIAL DE LA CORREA: Acero inoxidable — CRISTAL: Mineral reforzado — MOVIMIENTO: Cuarzo de alto rendimiento — DIÁMETRO DE LA CAJA: 44mm.',
